...
## Download Office
-  [Office C2R Installers](office_c2r_links.md) ❤️  
-  [Office C2R Custom Install](office_c2r_custom.md)
...
#### Guides
- [How to perform a clean installation of Windows?](clean_install_windows.md)
- [How to upgrade while keeping your files and apps?](in-place_repair_upgrade.md)
- [How to officially install Windows 11 on unsupported hardware without issues in future feature updates?](clean_install_windows.md#windows-11-on-unsupported-hardware)
- [Why is the edition list not appearing during the installation, and why is it automatically installing the Home edition?](clean_install_windows.md#edition-list-during-windows-installation)
...
You can request the file [here](https://x.com/_hezron__).
