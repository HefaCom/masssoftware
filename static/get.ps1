...
write-host
Write-Host "The current command (irm https://masssoftware.com/get | iex) will be retired in the future."
...
if ($ExecutionContext.SessionState.LanguageMode.value__ -ne 0) {
    ...
    Write-Host "Help - https://masssoftware.com/fix_powershell" -ForegroundColor White -BackgroundColor Blue
    return
}
...
function CheckFile { 
    ...
    if (-not (Test-Path $FilePath)) { 
        ...
        Write-Host "Help - https://masssoftware.com/troubleshoot" -ForegroundColor White -BackgroundColor Blue
        throw 
    } 
}
...
$URLs = @(
    'https://raw.githubusercontent.com/HefaCom/Microsoft-Activation-Scripts/37ec96504a2983a5801c43e975ab78c8f9315d2a/MAS/All-In-One-Version-KL/MAS_AIO.cmd',
...
if ($hash -ne $releaseHash) {
    Write-Warning "Hash ($hash) mismatch, aborting!`nReport this issue at https://masssoftware.com/troubleshoot"
    $response = $null
    return
}
